...
for sudokuSize in sudokuSizes:
    ...
    workbook = xlsxwriter.Workbook('statistics_data/SATResults' + str(sudokuSize) + '.xlsx')
    ...
    for heuristic in heuristiclist:
        ...
        for sudoku in sudokuList:
            ...
            time = t.time() - t1
            timeList.append(
                time)  # keep track of time, whether or not is was solved, and how many numbers we start with
        ...
        i = 2
        for number, time, startLen, branches in zip(sudokuList, timeList, lengthList,
                                                    branchList):  # write all of our data into the excel file.
