...
def backtracking(cnf_formula, partial_assignment=None, heuristic=None, moms_k=0.5, backtrack_branches=0,
                 container=None, removed_unit_clauses_counter=0):
    ...
    if cnf_formula == -1:
        return [], backtrack_branches, removed_unit_clauses_counter
    if not cnf_formula:
        return partial_assignment, backtrack_branches, removed_unit_clauses_counter
    ...
    (sat, backtrack_branches, removed_unit_clauses_counter) = backtracking(remove_unit_literals(cnf_formula, variable),
    ...
    if not sat:
        (sat, backtrack_branches, removed_unit_clauses_counter) = backtracking(
    ...
    return sat, backtrack_branches, removed_unit_clauses_counter
...
if __name__ == '__main__':
    ...
    t1, t2 = 0, 0
    solution, branches, removed_unit_clauses_counter = None, None, 0
    ...
    if arguments.S1:
        print("NO HEURISTIC")
        t1 = time.time()
        (solution, branches, removed_unit_clauses_counter) = backtracking(clauses, removed_unit_clauses_counter=removed_unit_clauses_counter)
        t2 = time.time()
    # DLCS
    if arguments.S2:
        print("DLCS")
        t1 = time.time()
        (solution, branches, removed_unit_clauses_counter) = backtracking(clauses, heuristic="DLCS", removed_unit_clauses_counter=removed_unit_clauses_counter)
        t2 = time.time()
    # DLISN
    if arguments.S3:
        print("DLISN")
        t1 = time.time()
        (solution, branches, removed_unit_clauses_counter) = backtracking(clauses, heuristic="DLISN", removed_unit_clauses_counter=removed_unit_clauses_counter)
        t2 = time.time()
    # DLISP
    if arguments.S4:
        print("DLISP")
        t1 = time.time()
        (solution, branches, removed_unit_clauses_counter) = backtracking(clauses, heuristic="DLISP", removed_unit_clauses_counter=removed_unit_clauses_counter)
        t2 = time.time()
    # MOMS
    if arguments.S5:
        print("MOMS")
        t1 = time.time()
        (solution, branches, removed_unit_clauses_counter) = backtracking(clauses, heuristic="MOMS", moms_k=0.7, removed_unit_clauses_counter=removed_unit_clauses_counter)
        t2 = time.time()
    # VSIDS
    if arguments.S6:
        print("VSIDS")
        t1 = time.time()
        (solution, branches, removed_unit_clauses_counter) = backtracking(clauses, heuristic="VSIDS", removed_unit_clauses_counter=removed_unit_clauses_counter)
        t2 = time.time()
